...
void init(Handle<Object> exports) {
    ...
    exports->Set(NanNew<String>("x13"), FunctionTemplate::New(x13)->GetFunction());
    exports->Set(NanNew<String>("x14"), FunctionTemplate::New(x14)->GetFunction());
    exports->Set(NanNew<String>("nist5"), FunctionTemplate::New(nist5)->GetFunction());
    exports->Set(NanNew<String>("yescrypt"), FunctionTemplate::New(yescrypt)->GetFunction());
    exports->Set(NanNew<String>("neoscrypt"), FunctionTemplate::New(neoscrypt)->GetFunction());
